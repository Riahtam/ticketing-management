            ...
            <div class="main-content-inner">
                <div class="row">
                    ...
                    <div class="col-12 mt-5">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="header-title"> CHOOSE PARK</h4>
                              
                                  <p>
                                    <ul>
                                    <li> <a href="manage-ticket.php"  style="color:black"> NOHKALIKA FALLS </a>  </li>
                                  <br> 
                                    <li>  <a href="manage-ticket.php"  style="color:black">KHARMIH PARK </a> </li>
                                   </ul>
                                   </p>
