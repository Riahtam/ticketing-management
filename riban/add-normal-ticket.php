...
if(isset($_POST['submit']))
  {
    ...
    $ticketid=mt_rand(100000000, 999999999);
        ...
        $query=mysqli_query($con, "insert into  tblticindian(TicketID,NoAdult,NoChildren,AdultUnitprice,ChildUnitprice,pname) value('$ticketid','$noadult','$nochildren','$aprice','$cprice','')");
    if ($query) {
