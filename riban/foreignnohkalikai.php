                            ...
                            <div class="col-12 mt-5">
                                <div class="card">
                                    <div class="card-body" id="exampl">
                                        <?php
 $vid=$_GET['fnoh'];
$ret=mysqli_query($con,"select * from tblticforeigner where TicketID='$vid'");
$cnt=1;
...
?>
                                ...
                                <tr>
                                 ...
                                 <tr>
                                    ...
                                    <td style="padding-left: 10px;">$<?php  echo ($ta+$tc); 
                                                 $tm=$ta+$tc;
                                                 // echo $tem;
                                                 $_SESSION['pri'] =$tm;
                                    ?>
                                   ...
                                   <center> <a href='foreignpay.php?tids=<?php echo $tidsa; ?>'  style='color:black;margin-left:0%;color:green;font-size:24px'>Pay Now</a> </center>
