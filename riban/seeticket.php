                            ...
                            <div class="col-12 mt-5">
                                <div class="card">
                                    <div class="card-body" id="exampl">
                                        <?php
 $vid=$_GET['iv'];
$ret=mysqli_query($con,"select * from tblticindian where TicketID='$vid'");
$cnt=1;
 ...
 //echo $tid;?>
                               ...
                               $_SESSION['pr'] =$tem;
                                ?>
                                    ...
                                    <?php } ?>
                                    <center><a href='paynow.php?tid=<?php echo $tid; ?>'  style='color:black;margin-left:0%;font-size:24px;color:green'>Pay Now</a> </center>
