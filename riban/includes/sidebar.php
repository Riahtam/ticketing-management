   <div class="sidebar-menu">
            <div class="sidebar-header">
                <div class="logo">
                    <p style="color: white">SOHRA PARK ADMIN</p>
                </div>
            </div>
            <div class="main-menu">
                <div class="menu-inner">
                    <nav>
                        <ul class="metismenu" id="menu">
                            ...
                            <li>
                                <a href="choose.php" aria-expanded="true"><i class="ti-layout-sidebar-left"></i><span>Manage Type Ticket
                                    </span></a>
                               s
                            </li>
                        ...
                        <li>
                                <a href="index.php" aria-expanded="true"><i class="ti-folder"></i><span>User-side</span></a>
                               <!-- <ul class="collapse">
